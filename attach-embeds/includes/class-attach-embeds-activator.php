...
class Attach_Embeds_Activator {
	...
	public static function activate() {
		...
		update_option('preview_default_css', 'width:100%;\Npadding-top:0px;\Npadding-left:0px;\Npadding-right:0px;\Npadding-bottom:0px;', true);
		update_option('reaction_default_css', 'width:100%;\Npadding-top:0px;\Npadding-left:0px;\Npadding-right:0px;\Npadding-bottom:0px;', true);
